...
class CustomerServiceTest {
    ...
    void signUpCustomer() {
        ...
        Optional<Customer> findEmail = customerService.findByEmail("aliM@gmail.com");
        Assertions.assertTrue(findEmail.isPresent());
        Address address = new Address("Tehrane", "valiiasre", "koche1", "asa12", findEmail.get());
    ...
    @Order(5)
    void changePassword() {
        customerService.changePassword("amirM@gmail.com", "ASvSD@#423", "ASvSD@#1380");
        Optional<Customer> customer = customerService.findByEmail("amirM@gmail.com");
    ...
    @Order(7)
    void watchAndOrder() {
        Customer customer = customerService.findByEmail("amirM@gmail.com").get();
        ...
        Assertions.assertEquals(
                orderService.findByCustomerEmailAndOrderStatus("amirM@gmail.com",
